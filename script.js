...
let arrayOfStudents = [{"id":1,"first_name":"Chadwick","last_name":"Ayre","email":"cayre0@cam.ac.uk","gender":"Male","img_src":"https://robohash.org/corporisquiaperiam.png?size=50x50&set=set1","class":11,"marks":18,"passing":false,"city":"Moorreesburg"},
    ...
    function SearchStudent(event) {
       ...
       let sudentFound=false;
        ...
        function getStudentDetails(student) {
            ...
            if (student.first_name.toLowerCase() === fName.toLowerCase() && student.last_name.toLowerCase() === lName.toLowerCase()) {
                sudentFound=true;
    ...
    <tbody id="table-body2">
        ...
        tbody.forEach(row => {
            ...
            else if (row.querySelector(".stuGender")?.textContent.trim() === "Male") {
